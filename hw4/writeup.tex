...
\begin{description}
    ...
    The values of r0, r1, r2, and r4 will be stored in r3+1, r3+2, r3+3, and r3+4 respectively (i.e. [r3+1] = [r0], [r3+2] = [r1], [r3+3] = [r2], [r3+4] = [r4]). In addition, r3 will be set to r3+4 after it completes the previous function.
