...
\begin{description}
    ...
    \begin{enumerate}
        ...
        Instruction Register holds the next instruction to be executed. This instruction was fetched via the address in PC.
    \end{enumerate}
    ...
    \begin{enumerate}
        ...
        1110 01 0 1 1 1 0 0 0010 0001 000000000000
        \item LDR r3,[r4,r5] !
        
        1110 01 1 1 1 0 1 1 0100 0011 000000000101
        \item LDR r3,[r4],r5
        
        1110 01 1 0 1 0 0 1 0100 0011 000000000101
        \item LDR r3,[r4,\#-6] !
        
        1110 01 0 1 0 0 1 1 0100 0011 000000000110
    \end{enumerate}
...
\newpage
\section*{References}
\url{http://www.keil.com/support/man/docs/armasm/armasm_Bgbbfgia.htm}

\url{http://infocenter.arm.com/help/index.jsp?topic=/com.arm.doc.dui0489c/CIHDGFEG.html}
\end{document}